...
class LlamaModel {
    ...
    private func tokenize(text: String, addBos: Bool) -> [Token] {
        ...
        // parse_special=true so ChatML markers like <|im_start|> are tokenized
        // as their dedicated vocab IDs instead of being split into the literal
        // characters `<`, `|`, `im_start`, `|`, `>`. Without this the model
        // never sees the chat role tokens it was fine-tuned on and produces
        // text that mimics the scaffold character-by-character.
