...
- Upgraded the bundled `llama.cpp` xcframework from `b5046` to `b9374`, which unblocks `qwen3` GGUF loading while keeping LocalMind's vendored SwiftLlama patches in place.
